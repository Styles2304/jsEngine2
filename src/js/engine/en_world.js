 ...
 */
    class World {
        ...
        /**
         * Adds tile map to the World
         * @param {String} src Name of the image source
         * @param {Number} tileWidth Width of the tiles in the source
         * @param {Number} tileHeight Height of the tiles in the source
         * @param {Array} data Array generated by Tiled
         */
        addMap(src, tileWidth, tileHeight, data) {
            this.map = new WorldMap(
                this.ctx,
                null,
                this.Game.images[src],
                tileWidth,
                tileHeight,
                data
            );
